/**
 * Copied from google's libcutils at https://android.googlesource.com/platform/system/core/+/donut-release/libcutils/hashmap.c
 * (removed thread related functions, as they are not necessary for me)
 */
/*
